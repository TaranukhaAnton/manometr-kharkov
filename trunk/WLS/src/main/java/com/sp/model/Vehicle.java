...
public class Vehicle extends LightVehicle {
	...
	public double getCostPerMileToDistance() {
		double distanceMiles = Util.getDistaceInMileByKM(todayJourneyDistance
				* Constants.KM_IN_METER);
		return distanceMiles * (long) getCostPerMile()
				/ (long) Constants.PENCES_IN_POUND;
	}
	...
	public void copyTo(Vehicle copy) {
		super.copyTo(copy);
        copy.code = code;
        copy.reseller = reseller;
		copy.renewalDate = renewalDate;
		copy.vin = vin;
		copy.phoneModel = phoneModel;
		copy.cabPhone = cabPhone;
		copy.status = status;
		copy.deleted = deleted;
		copy.poiDescr = poiDescr;
        copy.aoiDescr = aoiDescr;
		copy.ignitionActive = ignitionActive;
		copy.ignitionStatusVisibility = ignitionStatusVisibility;
		copy.todayJourneyDistance = todayJourneyDistance;
		copy.todayJourneyTime = todayJourneyTime;
		...
		copy.clientDescr = clientDescr;
        copy.lat = lat;
        copy.lon = lon;
        copy.firstUseDate = firstUseDate;
        copy.lastUseDate = lastUseDate;
        copy.motDate = motDate;
		copy.serviceDate = serviceDate;
		copy.insuranceDueDate = insuranceDueDate;
		copy.startOdo = startOdo;
		copy.startOdoDate = startOdoDate;
		copy.roadTaxDate = roadTaxDate;
		copy.gpsOdo = gpsOdo;
		copy.notes = notes;
		copy.mondayStartTimeHours = mondayStartTimeHours;
		copy.mondayStartTimeMins = mondayStartTimeMins;
		copy.tuesdayStartTimeHours = tuesdayStartTimeHours;
		copy.tuesdayStartTimeMins = tuesdayStartTimeMins;
		copy.wednesdayStartTimeHours = wednesdayStartTimeHours;
		copy.wednesdayStartTimeMins = wednesdayStartTimeMins;
		copy.thursdayStartTimeHours = thursdayStartTimeHours;
		copy.thursdayStartTimeMins = thursdayStartTimeMins;
		copy.fridayStartTimeHours = fridayStartTimeHours;
		copy.fridayStartTimeMins = fridayStartTimeMins;
		copy.saturdayStartTimeHours = saturdayStartTimeHours;
		copy.saturdayStartTimeMins = saturdayStartTimeMins;
		copy.sundayStartTimeHours = sundayStartTimeHours;
		copy.sundayStartTimeMins = sundayStartTimeMins;
		copy.mondayEndTimeHours = mondayEndTimeHours;
		copy.mondayEndTimeMins = mondayEndTimeMins;
		copy.tuesdayEndTimeHours = tuesdayEndTimeHours;
		copy.tuesdayEndTimeMins = tuesdayEndTimeMins;
		copy.wednesdayEndTimeHours = wednesdayEndTimeHours;
		copy.wednesdayEndTimeMins = wednesdayEndTimeMins;
		copy.thursdayEndTimeHours = thursdayEndTimeHours;
		copy.thursdayEndTimeMins = thursdayEndTimeMins;
		copy.fridayEndTimeHours = fridayEndTimeHours;
		copy.fridayEndTimeMins = fridayEndTimeMins;
		copy.saturdayEndTimeHours = saturdayEndTimeHours;
		copy.saturdayEndTimeMins = saturdayEndTimeMins;
		copy.sundayEndTimeHours = sundayEndTimeHours;
		copy.sundayEndTimeMins = sundayEndTimeMins;
		copy.odoStartTimeHours = odoStartTimeHours;
		copy.odoStartTimeMins = odoStartTimeMins;
		copy.monday = monday;
        ...
        copy.accelAvailable = accelAvailable;
        copy.currentDriver = currentDriver;
        copy.digitalInput1High = digitalInput1High;
		copy.digitalInput1Name = digitalInput1Name;
        copy.digitalInput2High = digitalInput2High;
		copy.digitalInput2Name = digitalInput2Name;
        copy.digitalInput3High = digitalInput3High;
		copy.digitalInput3Name = digitalInput3Name;
        copy.digitalInput4High = digitalInput4High;
		copy.digitalInput4Name = digitalInput4Name;
        copy.digitalInput5High = digitalInput5High;
		copy.digitalInput5Name = digitalInput5Name;
        copy.digitalInput6High = digitalInput6High;
		copy.digitalInput6Name = digitalInput6Name;
        copy.dotOnMap = dotOnMap;
        copy.lastActiveMsgId = lastActiveMsgId;
        copy.networkActive = networkActive;
        copy.networkArchived = networkArchived;
	}
