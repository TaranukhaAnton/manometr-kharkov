...
//    public static final String BOX_TYPE_FM_2100_DESCR = "FM2100";
    ...
    public static enum FEATURE {
        Green_Driving_Allowed("Prevailing Speed Limits", "device"), IOS_Appplication("iOS", "account"), Speed_Limit_Allowed("Seven Digit Postcode", "account");
        ...
        private FEATURE(String name, String type) {
            this.name = name;
            this.type = type;
        }
    }
