...
public class SearchDialog extends JDialog {
  ...
  void editFileButton_actionPerformed(ActionEvent e) {
      ...
      FileViewDialog d=new FileViewDialog(JOptionPane.getFrameForComponent(this),selFile.getPath(),false);
      d.setLocationRelativeTo(this);
      d.setContent(new FileElement(selFile.getPath()),true);
      d.show();             
  }  
  ...
  void searchButton_actionPerformed(ActionEvent e) {
    ...
    final File startFileDir=new File(startDir);
  ...
  private boolean isEligible(File f){
    ...
    if(match && findTextCheckBox.isSelected()){  //search within the file
      match=false;
      try{
        java.io.FileInputStream buf=new java.io.FileInputStream(f);        
        byte[] wholeFile =null; 
