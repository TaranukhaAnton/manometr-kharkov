...
<table>
    ...
    <tr>
        <td><textarea name="notes" class="width520"
            <%--<%= changesAllowed ? "" : textFieldDisab %>--%>
        ...
        <tr>
            <td>
                <div>
                    ...
                    <input type="button" value="+ Продукция"
                           onclick="javascript:void($('#addProduction-dialog').dialog('open'))"
                           class="butt">
                    <%} %>
                    ...
                    <input type="button" value="Копия"
                           onclick="javascript:void($('#copyInvoice-dialog').dialog('open'))"
                           class="butt">
                    <%} %>
            ...
            <td style="width: 50px;">
                <div>
                    ...
                    %>
                    <a href="invoiceAction.do?method=viewInvoice&id=<%=((Invoice) request.getAttribute("invoice")).getPrev()%>"><img
                            src="images/back.png"></a>
                    <%
                        }
                        if (invoice.getNext() != null) {
                    %>
                    <a href="invoiceAction.do?method=viewInvoice&id=<%=((Invoice) request.getAttribute("invoice")).getNext()%>"><img
...
<div id="divideInvoice-dialog" title="Разделить счета/кп">
    ...
    <form action="#" id="divideInvoice_form">
        ...
        <table>
            ...
            <tr>
                <td><label for="emploer1">Заказчик</label></td>
                <td><input type="text" name="employer1"   id="emploer1"
                           class="text ui-widget-content ui-corner-all"/>
                </td>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="consumer1"   id="consumer1" disabled="true"
                           class="text ui-widget-content ui-corner-all"/>
                </td>
                <td></td>
                <td>
                    <input type="text" name="consumer2"         disabled="true"
                           class="text ui-widget-content ui-corner-all"/>
                </td>
            </tr>
