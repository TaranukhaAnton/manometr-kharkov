...
<div class="tabs">
    ...
    <div id="id0">
        ...
        <display:table keepStatus="true" name="list0" requestURI="priceAction.do?method=redactListPriceForward"
    ...
    <div id="id1">
        ...
        <display:table keepStatus="true" name="list1" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
    ...
    <div id="id2">
        ...
        <display:table keepStatus="true" name="list2" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
    ...
    <div id="id3">
        ...
        <display:table keepStatus="true" name="list3" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
    ...
    <div id="id4">
        ...
        <display:table keepStatus="true" name="list4" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
    ...
    <div id="id5">
        ...
        <display:table keepStatus="true" name="list5" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
    ...
    <div id="id6">
        ...
        <display:table keepStatus="true" name="list6" requestURI="priceAction.do?method=redactListPriceForward"
                       excludedParams="method"
