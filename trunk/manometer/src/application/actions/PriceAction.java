...
//        request.setAttribute("list1", dao.findListByParameter("type", 1));
    ...
    public ActionForward applyTmpValues(ActionMapping mapping, ActionForm form,
                                         HttpServletRequest request, HttpServletResponse response) {
        Factory.getPriceFirstDAO().applyTmpValues();
        return null;
    }
    ...
    public ActionForward priceValuesToTmp(ActionMapping mapping, ActionForm form,
                                        HttpServletRequest request, HttpServletResponse response) {
        Factory.getPriceFirstDAO().priceValuesToTmp();
        return null;
    }
