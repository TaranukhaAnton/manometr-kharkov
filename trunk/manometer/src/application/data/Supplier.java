...
public class Supplier {
    ...
    @Column(name="default_row", nullable = false, columnDefinition = "char(1) NOT NULL default 'N'")
    @Type(type = "yes_no")
    private boolean default_row;
//ALTER TABLE `supplier` ADD `default_row` CHAR(1) DEFAULT 'N' NOT NULL


    public boolean isDefault_row() {
        return default_row;
    }

    public void setDefault_row(boolean default_row) {
        this.default_row = default_row;
    }
