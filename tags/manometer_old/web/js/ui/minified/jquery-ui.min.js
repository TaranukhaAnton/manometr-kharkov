...
jQuery.ui || (function(b) {
    ...
    b.ui = {version:"1.8rc1",plugin:{add:function(d, e, g) {
...
(function(a) {
    ...
    a.extend(a.ui.draggable, {version:"1.8rc1",eventPrefix:"drag"});
...
(function(a) {
    ...
    a.extend(a.ui.droppable, {version:"1.8rc1",eventPrefix:"drop"});
...
(function(c) {
    ...
    c.extend(c.ui.resizable, {version:"1.8rc1",eventPrefix:"resize"});
...
(function(a) {
    ...
    a.extend(a.ui.selectable, {version:"1.8rc1"})
})(jQuery);
(function(a) {
    ...
    a.extend(a.ui.sortable, {version:"1.8rc1",eventPrefix:"sort"})
})(jQuery);
jQuery.effects || (function(g) {
    ...
    g.extend(g.effects, {version:"1.8rc1",save:function(l, m) {
...
(function(a) {
    ...
    a.extend(a.ui.accordion, {version:"1.8rc1",animations:{slide:function(j, h) {
...
(function(a) {
    a.widget("ui.autocomplete", {options:{minLength:1,delay:300},_create:function() {
        var b = this;
        this.element.addClass("ui-autocomplete").attr("autocomplete", "off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete", function(c) {
            var d = a.ui.keyCode;
            switch (c.keyCode) {case d.PAGE_UP:b._move("previousPage", c);break;case d.PAGE_DOWN:b._move("nextPage", c);break;case d.UP:b._move("previous", c);c.preventDefault();break;case d.DOWN:b._move("next", c);c.preventDefault();break;case d.ENTER:if (b.menu && b.menu.active) {
                c.preventDefault()
            }case d.TAB:if (!b.menu || !b.menu.active) {
                return
...
(function($) {
    ...
    $.extend(Datepicker.prototype, {markerClassName:"hasDatepicker",log:function() {
        ...
        if (inst == $.datepicker._curInst && inst.input && inst.input.is(":visible") && !inst.input.is(":disabled")) {
            $(inst.input[0]).focus()
        }
...
(function(b) {
    ...
    b.extend(b.ui.dialog, {version:"1.8rc1",uuid:0,maxZ:0,getTitleId:function(c) {
...
(function(f) {
    ...
    f.fn.position = function(i) {
        ...
        switch (i.at[0]) {case"right":j.left += k;break;case e:j.left += k / 2;break}
        switch (i.at[1]) {case"bottom":j.top += h;break;case g:j.top += h / 2;break}
        j.left += m[0];
        j.top += m[1];
        return this.each(function() {
            var u = f(this),s = u.outerWidth(),r = u.outerHeight(),p = f.extend({}, j),v,o,q;
            switch (i.my[0]) {case"right":p.left -= s;break;case e:p.left -= s / 2;break}
            switch (i.my[1]) {case"bottom":p.top -= r;break;case g:p.top -= r / 2;break}
...
(function(a) {
    ...
    a.extend(a.ui.progressbar, {version:"1.8rc1"})
})(jQuery);
(function(b) {
    var a = 5;
    ...
    b.extend(b.ui.slider, {version:"1.8rc1",eventPrefix:"slide"})
})(jQuery);
(function(b) {
    var a = 0;
    ...
    b.extend(b.ui.tabs, {version:"1.8rc1"});
