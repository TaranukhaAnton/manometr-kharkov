                ...
                $.post("testAction.do?method=getPressureSensor", {"invoiceItemId":invoiceItemId},
                        function(data) {
                            if (data.length > 0) {
                                ...
                                setupFields(response.model, response.item);
...
function parseResults() {
    ...
    document.mainForm.vm.disabled = response.vm != "true";
...
//{
//
//    if ((document.mainForm.p.checked) && (document.mainForm.pi.checked))
//    {
//        alert("\"П\" и \"ПИ\" несовместимо.");
//        return false;
//    }
//
//}
