...
public class Tmp {
    ...
    private static final int crossMap[] = {46, 45, 43, 42, 41, 39, 36, 35, 32, 31, 29, -1, 27, 21, 20, 19, 16, 11, 7, 6, 5, 4, 2, 28, 22};

    public static void main(String[] args) {
        for (int i = 0; i < 25; i++) {
            if (crossMap[i] == -1) {
                System.out.println("вход ацп " + (i + 1) + " -> свободный");
            } else {
//                System.out.println("вход ацп " + (i + 1) + " -> " + crossMap[i] + " -> " + alias1[crossMap[i]]);
