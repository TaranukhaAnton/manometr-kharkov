...
public class FileViewDialog extends JDialog {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.getInputMap(panel1.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("ESCAPE"),"escape");
    ...
    saveAsFileMenu.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        JFileChooser choose=new JFileChooser(view.getEl());
  ...
  public void setContent(FileElement el,boolean editable){
    view.setEl(el);
