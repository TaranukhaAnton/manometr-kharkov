...
<div id="content">
    <table>
        ...
        <tr>
            <td>ИНН</td>
            <td><input type="text" class="inp" name="inn" id="inn"
                       value="<%=(supplier.getInn()==null)?"":supplier.getInn()%>"/>
            </td>
        </tr>
        <tr>
            <td>ИНН/КПП</td>
        ...
        <tr>
            <td>т/с</td>
            <td><input type="text" class="inp" name="ts" id="ts"
                       value="<%=(supplier.getTs() ==null)?"":supplier.getTs()%>"/>
            </td>
        </tr>
        <tr>
            <td>Банк</td>
        ...
        <tr>
            <td>БИК</td>
            <td><input type="text" class="inp" name="BIC" id="BIC"
                       value="<%=(supplier.getBIC()==null)?"":supplier.getBIC()%>"/>
            </td>
        </tr>
        <tr>
            <td>к/с</td>
            <td><input type="text" class="inp" name="ks" id="ks"
                       value="<%=(supplier.getKs()==null)?"":supplier.getKs()%>"/>
            </td>
        </tr>
        <tr>
            <td>Валюта р/с</td>
        ...
        <tr>
            <td>Язык ввода/с</td>
            <td>
                <select name="language" id="language" onkeypressEn="true">

                <% for (Map.Entry<String, String> entry : Supplier.LANGUAGES.entrySet()) { %>
                <option value="<%=entry.getKey()%>"
                        <%= ((supplier.getLanguage() != null) && (entry.getKey().equals(supplier.getLanguage()))) ? "selected" : ""%>
                        ><%=entry.getValue()%>
                </option>
                <% } %>
