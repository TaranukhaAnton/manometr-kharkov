...
$(function() {
    ...
    $("#divideInvoice_form input[name='consumer1']").autocomplete("invoiceAction.do?method=findCustomers", {
        width :260,
        selectFirst :false
    }).click(function(){$(this).removeClass("error"); });
    $("#divideInvoice_form input[name='employer1']").autocomplete("invoiceAction.do?method=findCustomers", {
        width :260,
        selectFirst :false
    }).click(function(){$(this).removeClass("error"); });
    ...
    $("#divideInvoice_form input[name='consumer2']").autocomplete("invoiceAction.do?method=findCustomers", {
        width :260,
        selectFirst :false
    }).click(function(){$(this).removeClass("error"); });

    $("#divideInvoice_form input[name='employer2']").autocomplete("invoiceAction.do?method=findCustomers", {
        width :260,
        selectFirst :false
    }).click(function(){$(this).removeClass("error"); });
