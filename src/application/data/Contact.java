...
//        params.add("mobTel");
//        params.add("eMail");
//        params.add("purchaseRole1");
//        params.add("purchaseRole2");
//        params.add("purchaseRole3");
//        params.add("purchaseRole4");
//        params.add("purchaseRole5");
//        params.add("purchaseRole6");
//        params.add("purchaseRole7");
//        params.add("status");
//        params.add("oldRecord");
//
//    }
